...
# want residuals to be white noise and mean centered at 0
# can try Model_111$fitted and Model_111$residuals
# PACF and ACF should look insignficant - still have some outside the blue lines, so lets try to improve

#Now let's try ARIMA(0,1,1) - means no error component, 
...
#Now let's try ARIMA(2,1,1) - 2 autoregressive terms, one moving avg
...
```{r}
# autoarima going to try to fit seasonal component - dont' fit seasonal compoent pls
Model_autofit <- auto.arima(deseasonal_residential_price,
                            max.D = 0,
                            max.P = 0,
                            max.Q = 0)
print(Model_autofit)
# lowecase would be for seasonal and uppercase is nonseasonal
# this function does everything we just did by ourselves
