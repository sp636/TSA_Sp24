...
> Answer: My previous experiences with time series is from EDE 872. We had a 1 week section about time series taught by Dr. Lima that gave us an overview of time series analysis and some of the basic components of it. We did not get into prediction in that week. My previous experience with R and Git are also from last semester's ENV872 course. We used R for the lab and weekly assignments and Git to organize our files and ultimately make our own final course group project.
...
> Answer: https://github.com/sp636/TSA_Sp24
