...
# gg plot will reverse if you use that to plot
```
...
# ACF: can see the seasonality is gone; strong time dependence in the dataset, even up to 40 lags there are still significant spikes - maybe need differencing.
autoplot(Acf(deseasonal_natgas, lag = 40, plot = F),
                main = "Deseasoned Natural Gas ACF")

#PACF: one significant lag at lag 1
...
# p val of 0.01, reject the null, conclude it doesnt have stochastic trend
print(adf.test(deseasonal_natgas))

# Mann-Kendall Test
# there is a trend, it is deterministic
...
AR could take on the trend, but differencing could help to not have to do AR4 or AR5. DIFFERENCE to remove the trend.
